...
A web application designed for users to build their own recipe collections. A user can sign up to create an account. Once logged in to the app, a user can create, edit, and delete their recipes and view the recipes of other users. A user can edit their account information and delete their account.  
